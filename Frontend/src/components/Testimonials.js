  ...
  const reviewsData = useMemo(
    () => ({
      karim: {
        ...
        images: [`${ASSET}/assets/reviews/karim1.jpg`, `${ASSET}/assets/reviews/karim2.jpg`, `${ASSET}/assets/reviews/karim3.jpg`],
      },
      kevin: {
        name: "Kevin Gemayel",
        rating: 5,
...
The installation was completed on schedule and in full compliance with safety standards, allowing our operations to proceed smoothly and without interruption. Their responsiveness and technical coordination were highly appreciated.`,
        images: [`${ASSET}/assets/reviews/kevin1.jpg`, `${ASSET}/assets/reviews/kevin2.jpg`, `${ASSET}/assets/reviews/kevin3.jpg`],
      },
      mohammad: {
        ...
        images: [`${ASSET}/assets/reviews/mohammad1.jpg`, `${ASSET}/assets/reviews/mohammad2.jpg`, `${ASSET}/assets/reviews/mohammad3.jpg`],
      },
      michael: {
...
Highly recommended!`,
        images: [`${ASSET}/assets/reviews/michael1.jpg`, `${ASSET}/assets/reviews/michael2.jpg`, `${ASSET}/assets/reviews/michael3.jpg`, `${ASSET}/assets/reviews/michael4.jpg`],
      },
      wadih: {
        name: "Wadih Karkabi",
        rating: 5,
...
Managing Director
Arch-Consult sarl.`,
        images: [`${ASSET}/assets/reviews/wadih1.jpg`, `${ASSET}/assets/reviews/wadih2.jpg`, `${ASSET}/assets/reviews/wadih3.jpg`, `${ASSET}/assets/reviews/wadih4.png`],
      },
      georges: {
        name: "Georges Homsi",
        rating: 5,
...
GroundFloor0819
George and Fadi`,
        images: [`${ASSET}/assets/reviews/georges1.jpg`, `${ASSET}/assets/reviews/georges2.jpg`, `${ASSET}/assets/reviews/georges3.jpg`, `${ASSET}/assets/reviews/georges4.jpg`, `${ASSET}/assets/reviews/georges5.jpg`],
      },
      francois: {
        name: "Francois Efrem",
        rating: 5,
...
We highly recommend everyone dealing with you, for any required scaffolding rental.`,
        images: [`${ASSET}/assets/reviews/Francois1.jpg`, `${ASSET}/assets/reviews/Francois2.jpg`, `${ASSET}/assets/reviews/Francois3.jpg`, `${ASSET}/assets/reviews/Francois4.jpg`],
      },
      ziad: {
        name: "Ziad Bou Dagher",
        rating: 5,
        text: `Really appreciate the way u manage your business. Well done`,
        images: [`${ASSET}/assets/reviews/ziad1.jpg`, `${ASSET}/assets/reviews/ziad2.jpg`, `${ASSET}/assets/reviews/ziad3.jpg`, `${ASSET}/assets/reviews/ziad4.jpg`],
      },
      jad: {
        name: "Jad Issa",
        rating: 5,
...
const midSliderSettings = {
  dots: true,
  arrows: false,
  infinite: false,
  autoplay: displayedTestimonials.length > 3,
  speed: 900,
  autoplaySpeed: 3500,
  pauseOnHover: true,
  swipeToSlide: true,
  ...
  responsive: [{ breakpoint: 1024, settings: { slidesToShow: 2, centerMode: false, centerPadding: "0px" } }],
}
      ...
      <section id="testimonials" className="mt-[50px] pb-[10px]" aria-labelledby={titleId}>
        <div className="max-w-[1450px] mx-auto px-[10px]">
          ...
          <div className="mt-[28px]">
           <div className="block md:hidden -mx-[12px]" aria-describedby={descId}>
    <Slider {...sliderSettings}>
      {displayedTestimonials.map((r) => (
        <div key={r.key} className="px-[12px]">
          <article className="w-full max-w-[240px] mx-auto">
            <div className="bg-white relative rounded-[16px] shadow-[0_15px_35px_rgba(0,0,0,0.08)] px-[18px] pt-[14px] pb-[84px] h-[380px] flex flex-col items-center text-center overflow-hidden">
              <div className="w-full flex flex-col items-center text-center pt-[6px]">
                <div className="w-full flex justify-center">
                  <div className="group relative w-[200px] h-[200px] rounded-none overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.1)]">
                    <img
                      src={r.thumb}
                ...
                <p
                  className="font-saira text-[13px] font-[400] text-[#64748b] leading-[20px] mt-[12px] px-[4px]"
                  style={{
                    display: "-webkit-box",
                ...
                <div className="text-[#FFB000] text-[20px] leading-none tracking-[2px]  mt-[-10px]" aria-label={`${r.rating} out of 5 stars`}>
                  {"★".repeat(r.rating)}
                </div>
              </div>

              <div className="absolute left-0 right-0 bottom-0 bg-white/95 backdrop-blur-sm border-t border-[#e2e8f0] py-[12px] px-[14px]">
                <h3 className="text-h4 text-[#214f9b] text-center font-saira font-[800] leading-[1.1]">{r.name}</h3>
              </div>
            </div>
          </article>
        </div>
           ...
           <div className="hidden md:block xl:hidden -mx-[12px]" aria-describedby={descId}>
  <Slider {...midSliderSettings}>
    {displayedTestimonials.map((r) => (
      <div key={r.key} className="px-[12px]">
        <article className="w-full max-w-[280px] mx-auto">
          <div className="testimonial-card bg-white relative rounded-[16px] shadow-[0_15px_35px_rgba(0,0,0,0.08)] px-[18px] pt-[14px] pb-[64px] h-[390px] flex flex-col items-center text-center overflow-hidden">
            {/* IMAGE */}
            <div className="w-full flex justify-center">
              <div className="group relative w-full max-w-[240px] aspect-square rounded-none overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.1)]">
                <img
                  src={r.thumb}
                  alt={`Scaffolding project execution referenced by ${r.name}`}
                  loading="lazy"
                  decoding="async"
                  className="absolute inset-0 w-full h-full object-cover rounded-none transition duration-300 group-hover:scale-[1.04]"
                />
            ...
            {/* STARS */}
            <div className="text-[#FFB000] text-[22px] tracking-[2px] mt-[-10px]" aria-label={`${r.rating} out of 5 stars`}>
              {"★".repeat(r.rating)}
            </div>

            <div className="flex-1" />

            {/* NAME pinned INSIDE so it never clips */}
            <div className="absolute left-0 right-0 bottom-0 bg-white/95 backdrop-blur-sm border-t border-[#e2e8f0] py-[12px] px-[14px]">
              <h3 className="text-h4 text-[#214f9b] text-center font-saira font-[800] leading-[1.1]">{r.name}</h3>
            </div>
          </div>
            ...
            <div className="hidden xl:flex flex-row flex-wrap justify-center items-start gap-[20px]" aria-describedby={descId}>
              {displayedTestimonials.map((r) => (
                <article key={r.key} className="w-full max-w-[240px] xl:max-w-none xl:flex-[0_0_auto] xl:w-[calc(20%-16px)]">
                  <div className="bg-white relative rounded-[16px] shadow-[0_15px_35px_rgba(0,0,0,0.08)] px-[18px] pt-[14px] pb-[70px] h-[400px] flex flex-col items-center text-center overflow-hidden">
                   
                    <div className="w-full flex justify-center mt-[-1px] mb-[14px]">
                      <div className="group relative w-full max-w-[240px] aspect-square rounded-none overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.1)]">
                        <img
                          src={r.thumb}
                          alt={`Scaffolding project execution referenced by ${r.name}`}
                    ...
                    <div className="text-[#FFB000] text-[22px] tracking-[2px] mt-[-20px] mb-[-65px]" aria-label={`${r.rating} out of 5 stars`}>
                      {"★".repeat(r.rating)}
                    </div>
                  </div>

                  <h3 className="mt-[12px] text-h4 text-[#214f9b] text-center font-saira font-[700]">{r.name}</h3>
                </article>
              ))}
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-[12px]">
                {activeReview.images.map((img, i) => (
                  <img
                    ...
                    className="w-full h-[190px] rounded-none object-cover"
                    loading="lazy"
                    decoding="async"
                  />
                ))}
